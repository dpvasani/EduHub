        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-4">
              <li>
                <Link
                  href="https://linktr.ee/dpvasani56"
                  className="text-base text-black dark:text-gray-300 dark:hover:text-white"
                >
                  Youtube
                </Link>
              ...
              <li>
                <Link
                  href="https://www.instagram.com/dpvasani"
                  className="text-base text-black dark:text-gray-300 dark:hover:text-white"
                >
                  Instagram
                </Link>
              ...
              <li>
                <Link
                  href="https://www.github.com/dpvasani"
                  className="text-base text-black dark:text-gray-300 dark:hover:text-white"
                >
                  Github
                </Link>
          ...
          <div>
            ...
            Call Us: XXXXXXXXXXXXXX
            </p>
           
            <p className="text-base text-black dark:text-gray-300 dark:hover:text-white pb-2">
            Address: Ahmedabad University, Ahmedabad, Gujarat, India
            </p>
         
            <p className="text-base text-black dark:text-gray-300 dark:hover:text-white  pb-2">
            Mail Us: dpvasani56@gmail.com
            </p>
