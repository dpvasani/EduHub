...
export const reviews = [
  {
    ...
    comment:
    "I had the pleasure of exploring EduHub, a website that provides an extensive range of courses on various tech-related topics. I was thoroughly impressed with my experience, as the website offers a comprehensive selection of courses that cater to different skill levels and interests. If you're looking to enhance your knowledge and skills in the tech industry, I highly recommend checking out EduHub!",
  },
  {
    name: "Verna Santos",
  ...
  },
  {
    ...
    comment:
    "I had the pleasure of exploring EduHub, a website that provides an extensive range of courses on various tech-related topics. I was thoroughly impressed with my experience",
  },
  {
    name: "Rosemary Smith",
  ...
  },
  {
    ...
    comment:
    "Join EduHub! EduHub focuses on practical applications rather than just teaching the theory behind programming languages or frameworks. I took a lesson on creating a web marketplace using React JS, and it was very helpful in teaching me the different stages involved in creating a project from start to finish. Overall, I highly recommend EduHub to anyone looking to improve their programming skills and build practical projects. EduHub is a great resource that will help you take your skills to the next level.",
  },
];
